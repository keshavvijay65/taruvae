...
export default function FAQPage() {
    ...
    const faqs = [
        {
            ...
            answer: "We offer a wide range of premium organic products including cold-pressed oils (groundnut, coconut, sunflower, mustard, sesame, olive), premium desi cow bilona ghee, spices, superfoods, and combo packs. All our products are 100% pure and organic."
        },
        {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-white via-[#FDF8F1] to-white">
            ...
            <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl pt-[calc(var(--header-height,80px)+2rem)] pb-12 md:pb-16">
                {/* Enhanced Header */}
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-dark mb-4" style={{ fontFamily: 'var(--font-playfair), serif' }}>
                ...
                <div className="space-y-3 md:space-y-4">
                    {faqs.map((faq, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="bg-white rounded-xl border border-brand-100 shadow-sm hover:shadow-md hover:border-brand-300 transition-all duration-300 overflow-hidden"
                            >
                                <button
                                    onClick={() => toggleFAQ(index)}
                                    className="w-full p-5 md:p-6 text-left flex items-center justify-between gap-4 hover:bg-brand-50 transition-colors group"
                                >
                                    <div className="flex items-start gap-4 flex-1">
                                        <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-gold to-gold-dark rounded-lg flex items-center justify-center text-white font-bold text-sm md:text-base shadow-md">
                                            {index + 1}
                                        </div>
                                        <h3 className="text-base md:text-lg font-semibold text-brand-dark group-hover:text-gold transition-colors flex-1">
                                            {faq.question}
                                        </h3>
                                    </div>
                                    <div className={`flex-shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}>
                                        <svg className="w-5 h-5 md:w-6 md:h-6 text-brand-dark group-hover:text-gold transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                >
                                    <div className="px-5 md:px-6 pb-5 md:pb-6 ml-14 md:ml-16">
                                        <div className="pl-4 border-l-2 border-accent-400">
                ...
                <div className="mt-16 md:mt-20 bg-gradient-to-br from-brand-50 via-white to-brand-100 rounded-2xl border-2 border-brand-300/30 shadow-lg p-8 md:p-10 text-center relative overflow-hidden">
                    {/* Decorative Elements */}
                    <div className="absolute top-0 right-0 w-32 h-32 bg-gold/20 rounded-full blur-2xl"></div>
                    <div className="absolute bottom-0 left-0 w-24 h-24 bg-brand/20 rounded-full blur-2xl"></div>
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold text-brand-dark mb-3" style={{ fontFamily: 'var(--font-playfair), serif' }}>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <a
                                ...
                                className="inline-flex items-center gap-2 bg-brand hover:bg-brand-dark text-white px-8 py-3.5 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                            >
                            ...
                            <a
                                href="tel:8792421741"
                                className="inline-flex items-center gap-2 bg-white border-2 border-brand-dark text-brand-dark px-8 py-3.5 rounded-lg font-semibold hover:bg-brand-dark hover:text-white transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                            >
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
