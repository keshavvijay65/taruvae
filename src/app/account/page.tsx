        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="pt-[calc(var(--header-height,80px)+2rem)] pb-8 md:pb-12">
                <div className="container mx-auto px-6 md:px-8 lg:px-10 max-w-7xl">
                    ...
                    {/* User Info */}
                    <div className="bg-white border-2 border-brand-100 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6 shadow-sm">
                        <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                            {user?.photoURL ? (
                                <img
                                    src={user.photoURL}
                                    alt={user.name}
                                    className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-3 sm:border-4 border-brand-dark"
                                />
                            ) : (
                                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-brand-dark flex items-center justify-center text-white text-xl sm:text-2xl font-bold">
                    ...
                    <div className="bg-white border-2 border-gray-100 rounded-xl p-6 shadow-sm mb-6">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-accent-500 text-primary-900 rounded-lg font-semibold hover:bg-accent-600 transition-colors flex items-center gap-2"
                            >
                        ...
                        {/* Add Address Form */}
                        {showAddAddressForm && (
                            <div className="bg-soft border-2 border-brand-dark rounded-lg p-6 mb-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/20 ${addressErrors.firstName ? 'border-error' : 'border-border'}`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/20 ${addressErrors.lastName ? 'border-error' : 'border-border'}`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/20 ${addressErrors.email ? 'border-error' : 'border-border'}`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                maxLength={10}
                                                className={`w-full px-4 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/20 ${addressErrors.phone ? 'border-error' : 'border-border'}`}
                                            />
                                        ...
                                        <div className="md:col-span-2">
                                            ...
                                            <textarea
                                                ...
                                                rows={2}
                                                className={`w-full px-4 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-dark ${addressErrors.address ? 'border-red-500' : 'border-gray-200'}`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/20 ${addressErrors.city ? 'border-error' : 'border-border'}`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className={`w-full px-4 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/20 ${addressErrors.state ? 'border-error' : 'border-border'}`}
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                maxLength={6}
                                                className={`w-full px-4 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand/20 ${addressErrors.pincode ? 'border-error' : 'border-border'}`}
                                            />
                        ...
                        {addresses.length === 0 && !showAddAddressForm ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {addresses.map((addr) => (
                                    <div
                                        key={addr.id}
                                        className={`border-2 rounded-lg p-4 ${addr.isDefault
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-2">
                                            <div className="flex-1">
                                                {addr.isDefault && (
                                                    <span className="inline-block px-2 py-1 bg-gold text-white text-xs font-bold rounded mb-2">
                                                        Default
                                                    </span>
                                                )}
                                        ...
                                        <div className="flex gap-2 mt-3">
                                            {!addr.isDefault && (
                                                <button
                                                    ...
                                                    className="text-xs px-3 py-1 bg-brand text-white rounded hover:bg-brand-dark transition-colors"
                                                >
                                                    Set as Default
                                                </button>
                                            )}
                        ...
                        {orders.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {orders.map((order) => (
                                    <div
                                        key={order.orderId}
                                        className="border-2 border-gray-100 rounded-lg p-4 hover:border-gold transition-colors"
                                    >
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Link
                                                ...
                                                className="text-brand-dark hover:text-gold font-semibold text-sm transition-colors"
                                            >
                                                View Details →
                                            </Link>
                                        </div>
