            ...
            <div className="min-h-screen bg-white">
                ...
                <div className="container mx-auto px-6 md:px-8 lg:px-10 max-w-7xl pt-[calc(var(--header-height,80px)+2rem)] pb-20">
                    <div className="text-center">
                        ...
                        <Link
                            href="/products"
                            className="inline-block px-8 py-3 rounded-lg font-extrabold transition-all shadow-md hover:shadow-lg"
                            style={{
            ...
            <div className="pt-[calc(var(--header-height,80px)+2rem)] pb-8 md:pb-12">
                <div className="container mx-auto px-6 md:px-8 lg:px-10 max-w-7xl">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 mb-6 sm:mb-8">
                        ...
                        <Link
                            href="/products"
                            className="px-4 sm:px-6 py-2 rounded-lg text-sm sm:text-base font-extrabold transition-all shadow-md hover:shadow-lg whitespace-nowrap"
                            style={{
                                background: 'linear-gradient(135deg, #2F5D3A 0%, #1F3D2B 100%)',
                                color: '#FFFFFF'
                            }}
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 w-full">
                        {wishlist.map((product) => (
                            <div
                                key={product.id}
                                className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg hover:border-gold transition-all duration-300 flex flex-col w-full min-w-0"
                            >
                                {/* Product Image */}
                                ...
                                <div className="p-4 flex flex-col flex-grow">
                                    <h3 className="text-base font-bold text-brand-dark mb-2 line-clamp-2 min-h-[2.5rem]" style={{ fontFamily: 'var(--font-playfair), serif' }}>
                                        {product.name}
                                    </h3>
                                    ...
                                    <div className="mb-4 flex-grow">
                                        <div className="flex items-baseline gap-2 mb-1">
                                            <span className="text-2xl font-bold text-brand-dark" style={{ fontFamily: 'var(--font-playfair), serif' }}>
                                                ₹{product.price}
                                            </span>
                                    ...
                                    <button
                                        ...
                                        className="w-full py-2.5 rounded-lg text-sm font-semibold bg-brand-dark text-white hover:bg-gold transition-all duration-200 flex items-center justify-center gap-2"
                                    >
