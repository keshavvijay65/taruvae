...
import { getAllProductsFromFirebase } from '@/lib/firebaseProducts';
import { Product } from '@/context/CartContext';
import ProductDetailClient from './ProductDetailClient';

// Helper function to convert firebase Product to CartContext Product
function convertToCartProduct(firebaseProduct: any): Product {
    return {
        ...
        reviews: firebaseProduct.reviews || 0,
        inStock: firebaseProduct.inStock !== undefined ? firebaseProduct.inStock : (firebaseProduct.stock !== undefined ? firebaseProduct.stock > 0 : true),
        category: firebaseProduct.category || '',
        size: firebaseProduct.size || firebaseProduct.weight || '',
        description: firebaseProduct.description || '',
        features: firebaseProduct.features || [],
        benefits: firebaseProduct.benefits || [],
        originalPrice: firebaseProduct.originalPrice,
        discount: firebaseProduct.discount,
        hoverImage: firebaseProduct.hoverImage,
        // Properly convert boolean values (handle string "true"/"false" and actual booleans)
        isNew: firebaseProduct.isNew === true || firebaseProduct.isNew === 'true',
        isBestseller: firebaseProduct.isBestseller === true || firebaseProduct.isBestseller === 'true',
        isPrime: firebaseProduct.isPrime === true || firebaseProduct.isPrime === 'true',
    };
}
...
function getAllDefaultProducts(): Product[] {
    return [
        ...
        { id: 1, name: 'Cold Pressed Groundnut Oil', price: 430, size: '1000 ml', image: '/images/products/groundnut oi.jpg', rating: 4.5, reviews: 128, inStock: true, category: 'oil' },
        { id: 2, name: 'Cold Pressed Groundnut Oil', price: 250, size: '500 ml', image: '/images/products/groundnut oi.jpg', rating: 4.5, reviews: 95, inStock: true, category: 'oil' },
        { id: 3, name: 'Cold Pressed Groundnut Oil', price: 140, size: '250 ml', image: '/images/products/groundnut oi.jpg', rating: 4.5, reviews: 78, inStock: true, category: 'oil' },
        { id: 4, name: 'Cold Pressed Groundnut Oil', price: 70, size: '100 ml', image: '/images/products/groundnut oi.jpg', rating: 4.5, reviews: 45, inStock: true, category: 'oil' },
...
export default async function ProductDetailPage({ params }: PageProps) {
    ...
    try {
        ...
        if (firebaseProducts && firebaseProducts.length > 0) {
            // Convert firebase products to CartContext Product format
            products = firebaseProducts.map(convertToCartProduct);
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 max-w-7xl">
                    {product ? (
                        ...
                        <div className="text-center py-20">
                            ...
                            <a
                                href="/products"
                                className="px-6 py-3 rounded-lg font-extrabold transition-all shadow-md hover:shadow-lg inline-block"
                                style={{
