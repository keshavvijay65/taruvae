...
export default function BlogPostClient({ initialPost, initialRelatedPosts }: BlogPostClientProps) {
    ...
    return (
        <div className="min-h-screen rich-gradient">
            ...
            {/* Breadcrumb */}
            <div className="pt-[calc(var(--header-height,80px)+2rem)] pb-6">
            ...
            <article className="container mx-auto px-6 md:px-8 lg:px-10 max-w-4xl pb-16">
                ...
                {post.image && (
                    <div className="relative w-full h-80 md:h-[500px] mb-10 rounded-2xl overflow-hidden shadow-2xl border-2 border-gray-100">
                        {(() => {
                            ...
                            // For HTTP/HTTPS URLs (Firebase Storage or external), use directly
                ...
                <header className="mb-10">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6 leading-tight tracking-tight" style={{ fontFamily: 'var(--font-fraunces), serif' }}>
                        {post.title}
                    </h1>
                ...
                {post.tags && post.tags.length > 0 && (
                    <div className="mb-12 pt-8 border-t-2 border-gray-200">
                        <h3 className="text-xl font-bold text-gray-900 mb-5" style={{ fontFamily: 'var(--font-fraunces), serif' }}>Tags:</h3>
            ...
            {relatedPosts.length > 0 && (
                <section className="bg-gradient-to-b from-white to-gray-50/50 py-16 border-t-2 border-gray-200">
                    <div className="container mx-auto px-6 md:px-8 lg:px-10 max-w-7xl">
                        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-10 text-center" style={{ fontFamily: 'var(--font-fraunces), serif' }}>
                            Related Posts
                        </h2>
                            ...
                            {relatedPosts.map((relatedPost) => (
                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        ...
                                        <h3 className="font-extrabold text-lg text-gray-900 mb-3 line-clamp-2 group-hover:text-[#2D5016] transition-colors" style={{ fontFamily: 'var(--font-fraunces), serif' }}>
                                            {relatedPost.title}
                                        </h3>
