...
export default function ConfirmModal({
    ...
    const typeStyles = {
        danger: {
            confirmBg: 'bg-red-100 text-red-700 border-2 border-red-500 hover:bg-red-200',
            icon: (
        ...
        warning: {
            confirmBg: 'bg-yellow-100 text-yellow-700 border-2 border-yellow-500 hover:bg-yellow-200',
            icon: (
        ...
        info: {
            confirmBg: 'bg-blue-100 text-blue-700 border-2 border-blue-500 hover:bg-blue-200',
            icon: (
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all animate-scaleIn border-2 border-gray-200">
                ...
                <div className="p-6">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            onClick={onConfirm}
                            className={`flex-1 px-4 py-3 ${style.confirmBg} font-bold rounded-lg transition-all shadow-lg hover:shadow-xl`}
                        >
                            {confirmText}
                        </button>
                    </div>
