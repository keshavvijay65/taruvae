...
<<<<<<< HEAD
                    ...
                    if (homeProducts.length > 0) {
                        setDisplayProducts(homeProducts);
                    } else {
                        // If no products marked for home, fallback to bestsellers
...
<<<<<<< HEAD
                ...
                if (homeProducts.length > 0) {
                    ...
                    if (bestsellerProducts.length > 0) {
                        ...
                        // Keep default bestsellers
                        const defaultBestsellers = products.filter(product => product.isBestseller === true);
                        setDisplayProducts(defaultBestsellers);
                    }
                }
            }
...
<<<<<<< HEAD
    ...
    const filteredProducts = useMemo(() => {
        ...
        // Just filter by category if needed
